        ...
        <div class="demo-section k-content">
            <ul class="fieldlist">
                <li>
                    ...
                    <input id="client-name" type="text" class="k-textbox" style="width: 100%;" />
                </li>
                <li>
                    <label for="client-lastname">Last Name</label>
                    <input id="client-lastname" type="text" class="k-textbox" style="width: 100%;" />
                </li>
                <li>
                    <label for="client-email">E-Mail</label>
                    <input id="client-email" type="email" class="k-textbox" style="width: 100%;" />
                </li>
                {{-- <li>
